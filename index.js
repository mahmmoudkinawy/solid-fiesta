...
app.use(
  "/client",
  verifyRoles(allowedRoles.client),
  require("./routes/client")
);
// Routes For Delegate
app.use(
  "/delegate",
  verifyRoles(allowedRoles.delegate),
  require("./routes/delegate")
);
// Routes For SuperVisors
app.use(
  "/supervisor",
  verifyRoles(allowedRoles.supervisor),
  require("./routes/supervisor")
);
// Routes For Manager
app.use(
  "/manager",
  verifyRoles(allowedRoles.manager),
...
io.on("connection", (socket) => {
  ...
  socket.on("updateLocation", async (data) => {
    ...
    const deletgateLocation = await Location.findOne({
